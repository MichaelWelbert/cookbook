import 'package:cookbook/repository/model/meal_model.dart';

class MealData {
  MealData._();

  static List<MealModel> dummyMeals = [
    MealModel(
      id: "m1",
    ...
    MealModel(
      ...
      steps: [
        ...
        'faça uma Camada de presunto, coloque o abacaxi e o queijo no pão branco',
    ...
    MealModel(
      ...
      steps: [
        'Frite a carne de hambúrguer 4 minutos de cada lado ',
        'Frite rapidamente os pães 1 minuto de cada lado ',
        'Insara a carne de hambúrguer com tomate, pepino e cebola entre os pães',
        'Adicione ketchup a seu gosto',
      ],
    ...
    MealModel(
      ...
      steps: [
        'Amaciar a vitela por cerca de 2 4 min, passar sal em ambos os lados.',
        ...
        'Certifique-se de mexer a panela regularmente para que os schnitzels fiquem rodeados de óleo e o farelo se torne fofo.',
    ...
    MealModel(
      id: "m5",
      categoriesId: ["FastAndEasy", "LightAndHealthy", "Summer"],
    ...
    MealModel(
      ...
      ingredients: [
        ...
        '2 barras 70% chocolate amargo, quebrado em pedaços',
    ...
    MealModel(
      id: "m10",
      categoriesId: ["Summer", "FastAndEasy", "LightAndHealthy"],
